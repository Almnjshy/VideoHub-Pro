...
class YouTubePlugin : BasePlatformPlugin(isResolvable = true) {
...
class FacebookPlugin : BasePlatformPlugin(isResolvable = true) {
...
class TikTokPlugin : BasePlatformPlugin(isResolvable = true) {
...
class XPlugin : BasePlatformPlugin(isResolvable = true) {
    override val id = "x"
...
class InstagramPlugin : BasePlatformPlugin(isResolvable = true) {
...
class VimeoPlugin : BasePlatformPlugin(isResolvable = true) {
...
class DailymotionPlugin : BasePlatformPlugin(isResolvable = true) {
...
class RedditPlugin : BasePlatformPlugin(isResolvable = true) {
...
class TwitchPlugin : BasePlatformPlugin(isResolvable = true) {
...
class SoundCloudPlugin : BasePlatformPlugin(isResolvable = true) {
...
class PinterestPlugin : BasePlatformPlugin(isResolvable = true) {
...
class LinkedInPlugin : BasePlatformPlugin(isResolvable = true) {
...
class TumblrPlugin : BasePlatformPlugin(isResolvable = true) {
...
class StreamablePlugin : BasePlatformPlugin(isResolvable = true) {
